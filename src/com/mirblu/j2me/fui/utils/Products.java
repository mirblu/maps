package com.mirblu.j2me.fui.utils;

import com.mirblu.j2me.a.MirbluMapsMIDlet;
...
import com.mirblu.j2me.fui.items.image.FSplashScreen;
...
public class Products {
    ...
    private static final byte NEXT_SCREEN = FApp.STATE_SCREEN_PRODUCTS_SPLASH;
    ...
    public static final byte URI = 5;
    public static final byte HOTSPOT_ID = 6;
    public static final byte ATT_SIZE = 7;
    ...
    public static final Vector uriToMenu(int pos){
        ...
        for (; i < urisize + 1; i++) {
            ...
            } else if (urisDiv[i].startsWith("mailto:")) {
